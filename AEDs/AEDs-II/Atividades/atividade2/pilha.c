...
void almentarTamanho(struct pilha* pilha) {
    int novo = pilha->tamanho ? pilha->tamanho * 2 : 1;
    int *tmp = realloc(pilha->items, (size_t)novo * sizeof *tmp);
